# Introducción a la Integración de Datos - Repositorio de Tareas
...
* **tarea_clase_5 - Pipeline ELT de Datos Ambientales**
  Implementación de un flujo de datos completo extrayendo métricas de la API de OpenWeatherMap y calidad del aire. Utiliza **Airbyte** para la extracción, **MotherDuck (DuckDB)** como Data Warehouse y **dbt** para la transformación y modelado final en una One Big Table (OBT).
...
* **Transformación de Datos (T):** dbt (Data Build Tool), SQL
